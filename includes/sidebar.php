...
$nav_items = [
    ...
    ['HR Home', 'index.php', 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', $is_admin, false, false],
    ['Add Supervisor', 'add_supervisor.php', 'M12 6v6m0 0v6m0-6h6m-6 0H6', $is_admin, false, false],
    ...
    ['Leave Allocation', 'leave_allocation.php', 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', true, true, false],
    ...
    ['Notice Period', 'notice_period.php', 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', true, true, false],
    ['Termination', 'termination.php', 'M13 7a4 4 0 11-8 0 4 4 0 018 0zM9 14a6 6 0 00-6 6v1h12v-1a6 6 0 00-6-6zM21 12h-6', true, true, false],
    ['Termination Oversight', 'admin_termination_oversight.php', 'M13 7a4 4 0 11-8 0 4 4 0 018 0zM9 14a6 6 0 00-6 6v1h12v-1a6 6 0 00-6-6zM21 12h-6', true, false, false],
    ['Termination Oversight', 'hr_termination_oversight.php', 'M13 7a4 4 0 11-8 0 4 4 0 018 0zM9 14a6 6 0 00-6 6v1h12v-1a6 6 0 00-6-6zM21 12h-6', false, true, false],
];
?>
