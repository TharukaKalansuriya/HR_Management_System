...
<div class="mb-10">
    <div class="flex justify-between items-center mb-6">
        ...
        <button id="toggleCalendarBtn" class="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 hover:bg-blue-600 hover:text-white text-blue-600 px-5 py-2.5 rounded-xl font-bold transition-all shadow-sm">
    ...
    <div id="calendarContainer" class="hidden bg-white rounded-3xl shadow-sm border border-slate-100 p-6 md:p-8 overflow-hidden transition-all duration-300">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
            ...
            <div class="flex items-center gap-4 bg-slate-50 p-1.5 rounded-xl border border-slate-100">
                <button id="prevMonth" class="p-2 text-slate-400 hover:text-blue-600 hover:bg-white rounded-lg transition-all shadow-sm"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" /></svg></button>
                <h3 id="currentMonthYear" class="text-sm font-bold text-slate-700 min-w-[120px] text-center uppercase tracking-wider"></h3>
                <button id="nextMonth" class="p-2 text-slate-400 hover:text-blue-600 hover:bg-white rounded-lg transition-all shadow-sm"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" /></svg></button>
            </div>
        </div>
        
        <div class="grid grid-cols-7 gap-2 mb-4 text-center text-[10px] sm:text-xs font-bold text-slate-400 uppercase tracking-wider">
...
<!-- Modal -->
<div id="leaveModal" class="fixed inset-0 bg-slate-900/40 hidden z-[60] flex items-center justify-center backdrop-blur-sm opacity-0 transition-opacity duration-300">
    <div class="bg-white rounded-3xl shadow-2xl w-[90%] max-w-lg p-6 sm:p-8 transform scale-95 transition-transform duration-300" id="leaveModalContent">
        <div class="flex justify-between items-center mb-6">
            <div>
            ...
            <button id="closeModal" class="text-slate-400 hover:text-slate-600 bg-slate-50 hover:bg-slate-100 p-2 rounded-xl transition-colors">
