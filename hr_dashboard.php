...
<div class="flex flex-col flex-1 min-h-screen min-w-0" id="main-content">
    ...
    <header class="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between sticky top-0 z-40 shadow-sm">
        <div>
            ...
            <p class="text-xs text-slate-400 font-medium">Review and process employee leave requests</p>
        </div>
    ...
    <main class="flex-1 p-6 lg:p-8 overflow-y-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
            ...
            <div class="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p class="text-3xl font-bold text-slate-800"><?php echo $hr_approved_total; ?></p>
            ...
            <div class="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[10px] font-bold uppercase tracking-wider text-blue-500 bg-blue-50 px-2 py-1 rounded-lg">Today</span>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <div class="px-6 py-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2 class="text-lg font-bold text-slate-800">Pending Review Requests</h2>
                    <p class="text-xs text-slate-400 mt-0.5">Approve or reject employee leave applications</p>
                </div>
                <div class="relative">
                    ...
                    <tbody id="leavesTableBody" class="divide-y divide-slate-50">
                        <?php if (mysqli_num_rows($pending_result) > 0): ?>
                            ...
                            <tr class="hover:bg-slate-50/60 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <p class="text-sm text-slate-500 max-w-[200px] truncate" title="<?php echo htmlspecialchars($row['reason']); ?>"><?php echo htmlspecialchars($row['reason']); ?></p>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <form method="POST" class="flex items-center gap-2">
                                        ...
                                        <input type="text" name="admin_remark" placeholder="Comment..."
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center gap-3 text-slate-400">
                                        ...
                                        <p class="text-sm font-medium">No pending leave requests found.</p>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
