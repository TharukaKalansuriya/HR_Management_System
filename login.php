...
<body class="bg-mesh min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-600/20 rounded-full filter blur-[100px] animate-pulse-slow"></div>
    <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-indigo-600/10 rounded-full filter blur-[100px] animate-pulse-slow" style="animation-delay: 2s;"></div>

    <div class="max-w-md w-full relative z-10">
        <!-- Logo/Brand Section -->
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600/20 border border-blue-500/30 mb-4 backdrop-blur-sm">
        ...
        <div class="glass-card rounded-3xl p-8 md:p-10 shadow-2xl">
            ...
            <form action="login.php" method="POST" class="space-y-6">
                <?php if (!empty($error)): ?>
                    <div class="bg-red-500/10 border border-red-500/50 text-red-400 p-3 rounded-xl text-sm flex items-center gap-2 animate-shake">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <button type="button" id="togglePassword" class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-500 hover:text-blue-400 transition-colors">
                ...
                <div class="flex items-center gap-2 px-1">
                    <input type="checkbox" id="remember" class="w-4 h-4 rounded border-slate-700 bg-slate-900 text-blue-600 focus:ring-blue-500 focus:ring-offset-slate-950">
                    <label for="remember" class="text-sm text-slate-400 cursor-pointer select-none">Remember for 30 days</label>
                </div>
            ...
            <div class="mt-8 pt-6 border-t border-slate-800/50 text-center">
                <p class="text-sm text-slate-500">
                    New here? 
                    <a href="#" class="font-bold text-blue-400 hover:text-blue-300 underline underline-offset-4 decoration-2 decoration-blue-500/30 transition-colors">Contact HR Office</a>
                </p>
            </div>
        </div>
