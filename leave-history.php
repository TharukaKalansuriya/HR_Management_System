...
$query = "SELECT * FROM leaves WHERE user_id = '$user_id' AND status = 'Approved' AND admin_remark != ''";
if ($status_filter !== 'all') {
    $safe_filter = mysqli_real_escape_string($conn, $status_filter);
    $query .= " AND status = '$safe_filter'";
}
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse" id="leaveTable">
                    <thead>
