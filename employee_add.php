...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $position = $designation; // Keep position synced for backward compatibility with payroll/attendance
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">New Employee Profile</h2>
                        <p class="text-sm text-gray-500 mt-0.5">Complete all sections to register a new staff member</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <form action="employee_add.php" method="POST" class="p-8" id="employeeForm">
                    ...
                    <div id="tab-personal" class="tab-content">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <input type="text" name="first_name" id="first_name" required value="<?php echo htmlspecialchars($_POST['first_name'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>
                            <div class="sm:col-span-3">
                                <label for="last_name" class="block text-sm font-medium text-gray-700 mb-1">Last Name <span class="text-red-500">*</span></label>
                                <input type="text" name="last_name" id="last_name" required value="<?php echo htmlspecialchars($_POST['last_name'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="full_name" class="block text-sm font-medium text-gray-700 mb-1">Full Name (Display Name)</label>
                                <input type="text" name="full_name" id="full_name" placeholder="Leave empty to auto-fill" value="<?php echo htmlspecialchars($_POST['full_name'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="nic_no" class="block text-sm font-medium text-gray-700 mb-1">NIC Number</label>
                                <input type="text" name="nic_no" id="nic_no" value="<?php echo htmlspecialchars($_POST['nic_no'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="date_of_birth" class="block text-sm font-medium text-gray-700 mb-1">Date of Birth</label>
                                <div class="flex space-x-2">
                                    <input type="date" name="date_of_birth" id="date_of_birth" onchange="calculateAge()" value="<?php echo htmlspecialchars($_POST['date_of_birth'] ?? ''); ?>" class="flex-1 rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <textarea name="address" id="address" rows="2" class="w-full rounded-lg border border-gray-300 py-2 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all"><?php echo htmlspecialchars($_POST['address'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    ...
                    <div id="tab-contact" class="tab-content hidden">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <input type="email" name="email" id="email" required value="<?php echo htmlspecialchars($_POST['email'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="phone" class="block text-sm font-medium text-gray-700 mb-1">Mobile Phone</label>
                                <input type="text" name="phone" id="phone" value="<?php echo htmlspecialchars($_POST['phone'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="phone_secondary" class="block text-sm font-medium text-gray-700 mb-1">Secondary / Home Phone</label>
                                <input type="text" name="phone_secondary" id="phone_secondary" value="<?php echo htmlspecialchars($_POST['phone_secondary'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>
                        </div>
                    ...
                    <div id="tab-emergency" class="tab-content hidden">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <input type="text" name="emergency_name" id="emergency_name" value="<?php echo htmlspecialchars($_POST['emergency_name'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="emergency_relationship" class="block text-sm font-medium text-gray-700 mb-1">Relationship</label>
                                <input type="text" name="emergency_relationship" id="emergency_relationship" placeholder="e.g. Spouse, Parent, Sibling" value="<?php echo htmlspecialchars($_POST['emergency_relationship'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="emergency_phone" class="block text-sm font-medium text-gray-700 mb-1">Emergency Phone Number</label>
                                <input type="text" name="emergency_phone" id="emergency_phone" value="<?php echo htmlspecialchars($_POST['emergency_phone'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>
                        </div>
                    ...
                    <div id="tab-statutory" class="tab-content hidden">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <input type="text" name="epf_number" id="epf_number" value="<?php echo htmlspecialchars($_POST['epf_number'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="etf_number" class="block text-sm font-medium text-gray-700 mb-1">ETF Number</label>
                                <input type="text" name="etf_number" id="etf_number" value="<?php echo htmlspecialchars($_POST['etf_number'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-6 bg-gray-50/70 p-4 rounded-xl border border-gray-200/80">
                                <div class="flex items-center mb-3">
                                    <input type="checkbox" name="has_tin" id="has_tin" value="1" onchange="toggleTinField()" <?php echo (isset($_POST['has_tin']) && $_POST['has_tin'] == '1') ? 'checked' : ''; ?> class="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-600">
                                    <label for="has_tin" class="ml-2 block text-sm font-medium text-gray-800">Tax File Applicable (Has TIN Number)</label>
                                </div>
                                
                                <div id="tin_field_container" class="transition-all mt-3 <?php echo (isset($_POST['has_tin']) && $_POST['has_tin'] == '1') ? '' : 'hidden'; ?>">
                                    <label for="tin_number" class="block text-xs font-medium text-gray-500 mb-1 uppercase">TIN Number</label>
                                    <input type="text" name="tin_number" id="tin_number" value="<?php echo htmlspecialchars($_POST['tin_number'] ?? ''); ?>" class="w-full sm:w-1/2 rounded-lg border border-gray-300 py-2 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all bg-white">
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="tab-bank" class="tab-content hidden">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <input type="text" name="bank_name" id="bank_name" placeholder="e.g. Commercial Bank, BOC" value="<?php echo htmlspecialchars($_POST['bank_name'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="bank_branch" class="block text-sm font-medium text-gray-700 mb-1">Branch</label>
                                <input type="text" name="bank_branch" id="bank_branch" value="<?php echo htmlspecialchars($_POST['bank_branch'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="bank_acc_no" class="block text-sm font-medium text-gray-700 mb-1">Account Number</label>
                                <input type="text" name="bank_acc_no" id="bank_acc_no" value="<?php echo htmlspecialchars($_POST['bank_acc_no'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="bank_acc_owner" class="block text-sm font-medium text-gray-700 mb-1">Account Owner's Name</label>
                                <input type="text" name="bank_acc_owner" id="bank_acc_owner" placeholder="As displayed in bank passbook" value="<?php echo htmlspecialchars($_POST['bank_acc_owner'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>
                        </div>
                    ...
                    <div id="tab-employment" class="tab-content hidden">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <select name="employment_type" id="employment_type" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all bg-white">
                                    <option value="Permanent" <?php echo (isset($_POST['employment_type']) && $_POST['employment_type'] === 'Permanent') ? 'selected' : ''; ?>>Permanent</option>
                                    <option value="Contract" <?php echo (isset($_POST['employment_type']) && $_POST['employment_type'] === 'Contract') ? 'selected' : ''; ?>>Contract</option>
                                    <option value="Casual" <?php echo (isset($_POST['employment_type']) && $_POST['employment_type'] === 'Casual') ? 'selected' : ''; ?>>Casual</option>
                                    <option value="Part-time" <?php echo (isset($_POST['employment_type']) && $_POST['employment_type'] === 'Part-time') ? 'selected' : ''; ?>>Part-time</option>
                                    <option value="Trainee" <?php echo (isset($_POST['employment_type']) && $_POST['employment_type'] === 'Trainee') ? 'selected' : ''; ?>>Trainee</option>
                                </select>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <select name="assigned_shift_id" id="assigned_shift_id" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all bg-white">
                                    ...
                                    <?php foreach ($shifts as $sh): ?>
                                        <option value="<?php echo $sh['id']; ?>" <?php echo (isset($_POST['assigned_shift_id']) && $_POST['assigned_shift_id'] == $sh['id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <input type="text" name="grade" id="grade" placeholder="e.g. Level 1, Executive, Managerial" value="<?php echo htmlspecialchars($_POST['grade'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="date_joined" class="block text-sm font-medium text-gray-700 mb-1">Date Joined</label>
                                <input type="date" name="date_joined" id="date_joined" value="<?php echo htmlspecialchars($_POST['date_joined'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="probation_period" class="block text-sm font-medium text-gray-700 mb-1">Probation Period</label>
                                <input type="text" name="probation_period" id="probation_period" placeholder="e.g. 3 Months, 6 Months" value="<?php echo htmlspecialchars($_POST['probation_period'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="confirmation_date" class="block text-sm font-medium text-gray-700 mb-1">Confirmation Date</label>
                                <input type="date" name="confirmation_date" id="confirmation_date" value="<?php echo htmlspecialchars($_POST['confirmation_date'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>

                            <div class="sm:col-span-3">
                                <label for="branch_location" class="block text-sm font-medium text-gray-700 mb-1">Branch / Location</label>
                                <input type="text" name="branch_location" id="branch_location" placeholder="e.g. Head Office, Colombo" value="<?php echo htmlspecialchars($_POST['branch_location'] ?? ''); ?>" class="w-full rounded-lg border border-gray-300 py-2.5 px-3 text-gray-900 focus:ring-2 focus:ring-brand-600 focus:border-brand-600 text-sm outline-none transition-all">
                            </div>
                        ...
                        <div class="mt-8 flex items-center justify-between pt-6 border-t border-gray-100">
                            ...
                            <div class="flex space-x-3">
                                ...
                                <button type="submit" class="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2.5 px-8 rounded-lg transition-colors text-sm shadow-md flex items-center">
                                    <i class="fa-solid fa-check mr-2"></i> Register Employee
                                </button>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    calculateAge();
    toggleTinField();
    updateRoles(<?php echo json_encode($_POST['designation'] ?? ''); ?>);
});
</script>
</body>
</html>
